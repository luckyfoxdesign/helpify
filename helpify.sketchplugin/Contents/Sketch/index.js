    ...
    if (e) return;else {
      try {
        if (v != "") {
          ...
          } else sketch__WEBPACK_IMPORTED_MODULE_0___default.a.UI.message("🙄 use object");
        } else sketch__WEBPACK_IMPORTED_MODULE_0___default.a.UI.message("🙄 input can`t be empty");
      } catch (e) {
        sketch__WEBPACK_IMPORTED_MODULE_0___default.a.UI.message("🙄 bad string:" + e.name + e.message);
      }
    }
  });
});
